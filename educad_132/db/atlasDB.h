...
#define c_AtlasDB_Version "atlasDB version = 2.70"
...
private:
  ...
  list <atlasDsnVia * >::iterator netViaListPos;
  ...
  list <atlasDsnVia *>::iterator layoutViaListPos;
  ...
  map <string, atlasTool *>::iterator toolListPos;
  atlasDsnBin *activeBin;
  list < atlasDsnInstance * >::iterator activeBinInstanceListPos;
  map < atlasString, atlasDsnBinNet *>::iterator activeBinNetListPos;
  list <atlasDsnPin *>::iterator activeBinNetPinListPos;
  list <atlasPoint *>::iterator macroPinGridPointListPos;
  list <atlasRect *>::iterator activeVertexRectListPos;
  map <atlasString, atlasString>::iterator toolReportListPos;
  list <atlasString>::iterator toolHistoryListPos;
public:
  ...
  **/
  ...
  //grid points of pin
  void resetMacroPinGridPointListPos();
  bool hasAnyGridPointInMacroPinGridPointList();
  bool macroPinGridPointListPosGoForward();
  long int getMacroPinGridPointX();
  long int getMacroPinGridPointY();
  ...
  **/
  ...
  bool disconnectNetFromPin( string pinName, string instName);
  ...
  **/
  ...
  bool setNetUse(string netName, TNetUse use);
  /**
  ==============================================================================
  ...
  **/
  ...
  bool flushFloorplanDieRegionList();
  ...
  **/
  ...
  void resetFloorplanDieRegionVirtualPinListPos();
  ...
  **/
  ...
  //add via to layer
  bool addLayoutVia(string viaName, long int x, long int y, string net);
  ...
  **/
  ...
  string getLayoutNetRectLayerName();
  ...
  //reading vias of a net
  long int getLayoutNetViaNum(string netName);
  void resetLayoutNetViaListPos(string netName);
  bool hasAnyViaInLayoutNetViaList(string netName);
  bool layoutNetViaListPosGoForward(string netName);
  string getLayoutNetViaName();
  long int getLayoutNetViaX();
  long int getLayoutNetViaY();

  //reading layout->vias
  long int getLayoutAllViaNum();
  void setLayoutViaName(string viaName);
  ...
  **/
  ...
  bool setActiveBinByCoordinate(long int x, long int y);
  long int getActiveBinRow();
  long int getActiveBinColumn();
  //read instances of active bin
  long int getActiveBinInstanceNum();
  bool resetActiveBinInstanceListPos();
  bool hasAnyInstanceInActiveBinInstanceList();
  bool activeBinInstanceListPosGoForward();
  string getActiveBinInstanceName();
  //read nets & pins of active bin
  long int getActiveBinNetNum();
  bool resetActiveBinNetListPos();
  bool hasAnyNetInActiveBinNetList();
  bool activeBinNetListPosGoForward();
  string getActiveBinNetName();
  long int getActiveBinNetPinNum();
  bool resetActiveBinNetPinListPos();
  bool hasAnyPinInActiveBinNetPinList();
  bool activeBinNetPinListPosGoForward();
  string getActiveBinNetPinName();
  ...
  **/
  ...
  //reading react of a bin (routed) after selecting a bin & its layer
  void resetActiveVertexRectListPos();
  bool hasAnyRectInActiveVertexRectList();
  bool activeVertexRectListPosGoForward();
  string getActiveVertexRectLayerName();
  string getActiveVertexRectNetName();
  long int getActiveVertexRectTop();
  long int getActiveVertexRectLeft();
  long int getActiveVertexRectBottom();
  long int getActiveVertexRectRight();
  ...
  **/
  ...
  bool setTool(string toolName, TToolType type, string info);
  bool setToolExecutionStatus(string toolName, TToolExecutionStatus es);
  bool addToolReport(string toolName, string reportName, string reportVal);
  bool addToolHistory(string toolName, string history);
  ...
  **/
  long int getToolNum();
  void resetToolListPos();
  bool hasAnyToolInToolList();
  bool toolListPosGoForward();
  string getToolName();
  TToolType getToolType();
  string getToolInfo();
  TToolExecutionStatus getToolExecutionStatus();
  bool setActiveReportRandomAccess(string reportName);
  void resetToolReportListPos();
  bool hasAnyReportInToolReportList();
  bool toolReportListPosGoForward();
  string getToolReportName();
  string getToolReportValue();
  void resetToolHistoryListPos();
  bool hasAnyHistoryInToolHistoryList();
  bool toolHistoryListPosGoForward();
  string getToolHistory();
